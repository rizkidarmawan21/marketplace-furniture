<x-dashboard-layout>
    <div x-data="{
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button type="submit" class="hover:text-primary"
                                            @click="confirmUrl = '{{ route('admin.articles.destroy', $item->id) }}', document.querySelector('.confirmModal').classList.remove('hidden') ">
                                        ...
                                        <button class="hover:text-primary"
                                            @click="isEdit = true, selectedValue = { id: '{{ $item->id }}', title: '{{ $item->title }}', content: '{{ $item->content }}', image: '{{ asset($item->image_path) }}' }, modalCreate = true">
        ...
        @include('pages.articles.modal-create')
