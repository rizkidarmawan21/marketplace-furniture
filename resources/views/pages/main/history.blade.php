                        ...
                        @forelse ($transactions as $item)
                            <div class="item-cart border border-zinc-300 rounded-lg">
                                <div class="mt-3 px-5 flex justify-between">
                                    <button
                                        class="bg-feprimary px-3 text-xs text-white rounded-md hover:bg-feprimary/50"
                                    ...
                                    <div class="flex w-[80%] gap-4 items-center">
                                        ...
                                        <div class="w-1/2 self-start">
                                            ...
                                            @switch($item->status)
                                                @case('pending')
                                                    <label
                                                        class="mt-1 text-xs bg-yellow-400 text-white px-3 py-0.5 rounded-[4px]">
                                                        Pending
                                                    </label>
                                                @break
                                                ...
                                                @case('onprogress')
                                                    <label
                                                        class="mt-1 text-xs bg-yellow-500 text-white px-3 py-0.5 rounded-[4px]">
                                                        On Progress
                                                    </label>
                                                @break
                                                ...
                                                @case('sent')
                                                    <label
                                                        class="mt-1 text-xs bg-teal-500 text-white px-3 py-0.5 rounded-[4px]">
                                                        Sent
                                                    </label>
                                                @break
                                ...
                                <div class="py-2 px-5 flex items-center justify-between border-t border-zinc-300">
                                    <div>
                                        ...
                                        @endif
                                        @if ($item->status == 'sent')
                                            <form action="{{ route('my-orders.received', $item->id) }}" method="post"
                                                class="inline-block">
                                                @csrf
