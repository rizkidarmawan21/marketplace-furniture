<x-app-layout>
    <div class="flex justify-center  mt-10">
        <div class="w-[90%] lg:container ">
            <div class="flex min-h-[calc(100vh-18rem)] justify-center  mt-5" x-data="checkout">
                        ...
                        <div class="flex justify-center items-center h-full">
                            <h1 class="flex items-center gap-3">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                    ...
                                    <defs>
                                        <pattern id="pattern0_1_2386" patternContentUnits="objectBoundingBox"
                                            width="1" height="1">
                                        ...
                                        <div>
                                            <div class="grid grid-cols-2 gap-5">
                                                <div class="flex flex-col gap-2">
                                                    <label for="name"
                                                        class="text-base text-[#515151] font-semibold">Nama
                                                        Penerima</label>
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    <label for="phone_number"
                                                        class="text-base text-[#515151] font-semibold">Nomor
                                                        Telepon</label>
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <select name="receiver_province"
                                                        ...
                                                        <template x-for="province in provinces" :key="province.id">
                                                            <option x-text="province.name" :value="province.name">
                                                            </option>
                                                        </template>
                                                    </select>
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    <label for="postal_code"
                                                        class="text-base text-[#515151] font-semibold">Kode
                                                        Pos</label>
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    <label for="postal_code"
                                                        class="text-base text-[#515151] font-semibold">Alamat
                                                        Lengkap</label>
